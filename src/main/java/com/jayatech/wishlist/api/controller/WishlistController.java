...
public class WishlistController {
    ...
    public ResponseEntity<Wishlist> createWishlist(@RequestBody UserDTO user) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(wishlistService.saveWishList(user.getId()));
    }
    ...
    public ResponseEntity<Wishlist> incrementWishlist(@PathVariable String wishlistId, @RequestBody ProductDTO product) {
